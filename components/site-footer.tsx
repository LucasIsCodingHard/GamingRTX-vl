      ...
      <div className="mx-auto max-w-7xl px-4 py-12">
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
              Tu tienda de confianza para PCs armadas y componentes gaming. Nuevos y usados con garantia.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="text-sm text-muted-foreground">+54 11 2345-6789</span>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="h-4 w-4 shrink-0 text-primary" />
                <span className="text-sm text-muted-foreground">ventas@gamingrtx.com</span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a
                href="https://instagram.com/gamingrtx"
                target="_blank"
              ...
              <a
                href="https://wa.me/5411234567890"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="WhatsApp"
                className="flex h-10 w-10 items-center justify-center rounded-lg border border-border bg-secondary text-muted-foreground transition-colors hover:border-primary hover:text-primary"
        ...
        <div className="mt-10 border-t border-border pt-6 text-center">
          <p className="text-xs text-muted-foreground">
            2026 gamingRTX. Todos los derechos reservados.
          </p>
        </div>
      </div>
    </footer>
